...
# --- Initial Welcome ---
echo "==================================================================="
echo " macOS Apple Intelligence Enablement Script 2.2 by KanShuRichard & Hikaru"
echo "           macOS Apple 智能启用辅助脚本 2.2 by KanShuRichard & Hikaru"
echo "==================================================================="
...
case "$LANG" in
    en*)
        MSG_TITLE="macOS Apple Intelligence Enablement Script 2.2 by KanShuRichard"
        ...
        ;;
    *) # Default to Chinese
        MSG_TITLE="macOS Apple Intelligence 启用辅助脚本 2.2 by KanShuRichard"
